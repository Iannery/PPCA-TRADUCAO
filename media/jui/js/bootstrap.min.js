      ...
      s ||
        ...
        e.isDefaultPrevented() ||
          ...
          t.support.transition && n.hasClass("fade")
            ? n.on(t.support.transition.end, i)
            : i());
    };
    var n = t.fn.alert;
    ...
    (t.fn.button = function (i) {
      return this.each(function () {
        var n = t(this),
          o = n.data("button"),
          s = "object" == typeof i && i;
        o || n.data("button", (o = new e(this, s))),
  ...
  (function (t) {
    ...
    e.prototype = {
      ...
      slide: function (e, i) {
        ...
        if (
          ((this.sliding = !0),
          a && this.pause(),
          (s = s.length ? s : this.$element.find(".item")[h]()),
          (n = t.Event("slide", { relatedTarget: s[0], direction: r })),
          !s.hasClass("active"))
        ) {
          if (
    ...
    (t.fn.carousel = function (i) {
      return this.each(function () {
        ...
        o || n.data("carousel", (o = new e(this, s))),
          "number" == typeof i
            ? o.to(i)
            : a
            ? o[a]()
  ...
  (function (t) {
    ...
    e.prototype = {
      ...
      hide: function () {
        ...
        !this.transitioning &&
          ...
          this.transition("removeClass", t.Event("hideme"), "hidden"),
          this.$element[e](0));
      },
      reset: function (t) {
      ...
      transition: function (e, i, n) {
        ...
        this.$element.trigger(i),
          i.isDefaultPrevented() ||
            ...
            this.$element[e]("in"),
            t.support.transition && this.$element.hasClass("collapse")
              ? this.$element.one(t.support.transition.end, s)
              : s());
      },
      toggle: function () {
    ...
    (t.fn.collapse = function (i) {
      return this.each(function () {
        ...
        o || n.data("collapse", (o = new e(this, s))),
          "string" == typeof i && o[i]();
      });
    }),
          ...
          s ||
            ...
            (s =
              ...
              (s = (s = o.attr("href")) && s.replace(/.*(?=#[^\s]+$)/, ""))
                ? ""
                : s)),
            (i = (n = t(document).find(s)).data("collapse")
              ? "toggle"
              : o.data()),
      ...
      return (
        n ||
          (n =
            ...
            n.replace(/.*(?=#[^\s]+$)/, "")),
        (n = "#" === n ? [] : n),
        ((i = n && t(document).find(n)) && i.length) || (i = e.parent()),
        i
      );
    }
    var n = "[data-toggle=dropdown]",
      o = function (e) {
        ...
        t("html").on("click.dropdown.data-api", function () {
          i.parent().parent().removeClass("nav-hover"),
    ...
    o.prototype = {
      ...
      toggle: function (n) {
        var o,
          ...
          h = t(this);
        if (
          !h.is(".disabled, :disabled") &&
          ((o = i(h)),
          (s = o.hasClass("open")),
          (r = o.parent().hasClass("nav-hover")) || "mouseover" != n.type)
        ) {
      ...
      keydown: function (e) {
        ...
        if (
          ...
          if (((a = i(o)), !(r = a.hasClass("open")) || (r && 27 == e.keyCode)))
            return 27 == e.which && a.find(n).focus(), o.click();
          (s = t("[role=menu] li:not(.divider):visible a", a)).length &&
            ((h = s.index(s.filter(":focus"))),
            38 == e.keyCode && h > 0 && h--,
            40 == e.keyCode && h < s.length - 1 && h++,
            ~h || (h = 0),
            s.eq(h).focus());
        }
      },
            ...
            a ||
              (a =
                "#" === (a = (a = s) && a.replace(/.*(?=#[^\s]+$)/, ""))
                  ? ""
                  : a),
            (n = (i = t(document).find(a)).data("modal")
              ? "toggle"
              : t.extend({ remote: !/#/.test(s) && s }, i.data(), o.data())),
    ...
    e.prototype = {
      ...
      init: function (e, i, n) {
        ...
        for (
          this.type = e,
            ...
            this.enabled = !0,
            h = (a = this.options.trigger.split(" ")).length;
          h--;
      ...
      enter: function (e) {
        ...
        if (
          ...
          !(i = t(e.currentTarget)[this.type](o).data(this.type)).options
            .delay || !i.options.delay.show)
        )
          return i.show();
          ...
          "bottom" == e || "top" == e
            ? ((o = 0),
              t.left < 0 &&
                ...
                (i = a[0].offsetWidth),
                (n = a[0].offsetHeight)),
              this.replaceArrow(o - r + i, i, "left"))
    ...
    (t.fn.tooltip = function (i) {
      return this.each(function () {
        var n = t(this),
          o = n.data("tooltip"),
          s = "object" == typeof i && i;
        o || n.data("tooltip", (o = new e(this, s))),
          "string" == typeof i && o[i]();
      });
    }),
    ...
    (t.fn.popover = function (i) {
      return this.each(function () {
        var n = t(this),
          o = n.data("popover"),
          s = "object" == typeof i && i;
        o || n.data("popover", (o = new e(this, s))),
          "string" == typeof i && o[i]();
      });
    }),
              ...
              return (
                (o &&
                  o.length && [
                    [
                      o.position().top +
                        (!t.isWindow(e.$scrollElement.get(0)) &&
      ...
      activate: function (e) {
        ...
        (this.activeTarget = e),
          ...
          (n =
            ...
            e +
            '"]'),
          (i = t(document).find(n).parent("li").addClass("active")).parent(
            ".dropdown-menu"
          ).length && (i = i.closest("li.dropdown").addClass("active")),
          i.trigger("activate");
      },
    };
    ...
    (t.fn.scrollspy = function (i) {
      return this.each(function () {
        var n = t(this),
          o = n.data("scrollspy"),
          s = "object" == typeof i && i;
        o || n.data("scrollspy", (o = new e(this, s))),
          "string" == typeof i && o[i]();
      });
    }),
    ...
    (t.fn.typeahead = function (i) {
      return this.each(function () {
        var n = t(this),
          o = n.data("typeahead"),
          s = "object" == typeof i && i;
        o || n.data("typeahead", (o = new e(this, s))),
          "string" == typeof i && o[i]();
      });
    }),
      ...
      if (this.$element.is(":visible")) {
        ...
        "object" != typeof s && (a = r = s),
          ...
          (e =
            ...
            (null != a && o.top + this.$element.height() >= i - a
              ? "bottom"
              : null != r && n <= r && "top")),
          this.affixed !== e &&
            ((this.affixed = e),
            (this.unpin = "bottom" == e ? o.top - n : null),
            this.$element
