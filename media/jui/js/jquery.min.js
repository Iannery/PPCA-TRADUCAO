...
!(function (e, t) {
  ...
  (d.event = {
    ...
    fix: function (e) {
      ...
      for (
        s ||
          (this.fixHooks[o] = s =
            pe.test(o) ? this.mouseHooks : de.test(o) ? this.keyHooks : {}),
    ...
    clone: function (e, t, n) {
      ...
      if (
        (f.html5Clone || d.isXMLDoc(e) || !we.test("<" + e.nodeName + ">")
          ? (o = e.cloneNode(!0))
          : ((ke.innerHTML = e.outerHTML), ke.removeChild((o = ke.firstChild))),
        !(
    ...
    return (
      n ||
        (("none" !== (n = Fe(e, t)) && n) ||
          ((t = (
            (_e = (
              _e || d("<iframe frameborder='0' width='0' height='0'/>")
            ).appendTo(t.documentElement))[0].contentWindow ||
            _e[0].contentDocument
          ).document).write(),
          t.close(),
          (n = Fe(e, t)),
          _e.detach()),
  ...
  e.getComputedStyle
    ? ((Ie = function (t) {
      ...
      ($e = function (e, t, n) {
        ...
        return (
          ("" !==
            (a = (n = n || Ie(e)) ? n.getPropertyValue(t) || n[t] : void 0) &&
            void 0 !== a) ||
      ...
      (r = e[a]).style &&
        ...
        t
          ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              U(r) &&
              (o[a] = d._data(r, "olddisplay", Oe(r.nodeName))))
          : ((i = U(r)),
            ((n && "none" !== n) || !i) &&
  ...
  function it(e, t, n) {
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = $e(e, t, o)) < 0 || null == i) && (i = e.style[t]), Pe.test(i))
      )
        return i;
        ...
        set: function (e, t) {
          ...
          (n.zoom = 1),
            ((t >= 1 || "" === t) &&
              ...
              (n.filter = Ue.test(o) ? o.replace(Ue, i) : o + " " + i);
        },
      }),
        ...
        1 === e.nodeType &&
          ...
          "inline" ===
            ("none" === (l = d.css(e, "display"))
              ? d._data(e, "olddisplay") || Oe(e.nodeName)
              : l) &&
            "none" === d.css(e, "float") &&
            (f.inlineBlockNeedsLayout && "inline" !== Oe(e.nodeName)
              ? (h.zoom = 1)
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? d.removeAttr(e, n)
            : (wt && bt) || !xt.test(n)
            ? e.setAttribute((!bt && d.propFix[n]) || n, n)
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            ...
            if ("string" === n)
              ...
              (void 0 !== e && "boolean" !== n) ||
                ((t = Nt(this)) && d._data(this, "__className__", t),
                d.attr(
                  this,
                  "class",
  ...
  d.extend({
    ...
    ajax: function (t, n) {
      ...
      f.hasContent ||
        (f.data &&
          ((o = f.url += (At.test(o) ? "&" : "?") + f.data), delete f.data),
        !1 === f.cache &&
          (f.url = Lt.test(o)
            ? o.replace(Lt, "$1_=" + St++)
            : o + (At.test(o) ? "&" : "?") + "_=" + St++)),
        ...
        return (
          ...
          r.always(function () {
            void 0 === o ? d(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), nn.push(i)),
  ...
  (d.fn.load = function (e, t, n) {
    ...
    d.each(["top", "left"], function (e, t) {
      d.cssHooks[t] = Xe(f.pixelPosition, function (e, n) {
        if (n)
          return (n = $e(e, t)), Pe.test(n) ? d(e).position()[t] + "px" : n;
      });
    }),
